...
func (o *Operation)Result() (float32, bool) {
...
func main(){
	cAdd := COperationAdd{}
	addObj := cAdd.createoperation("+")
	addObj.SetNumA(10)
	addObj.SetNumB(20)
	fmt.Println(addObj.Result())
	cSub := COperationSub{}
	cSubInter := cSub.createoperation("-")
	cSubInter.SetNumA(40)
	cSubInter.SetNumB(1)
	fmt.Println(cSubInter.Result())
